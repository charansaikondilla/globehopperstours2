        ...
        <footer className="relative bg-gradient-to-b from-black via-slate-950 to-black text-white border-t border-white/10">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12 mb-16">
                    ...
                    <div>
                        <h3 className="text-base sm:text-lg md:text-xl font-black mb-4 sm:mb-6 text-white flex items-center gap-2">
                            <span className="text-xl sm:text-2xl">{footerSections.travel.icon}</span>
                ...
                <div className="glass-card rounded-2xl sm:rounded-3xl md:rounded-[2.5rem] p-6 sm:p-8 md:p-12 mb-16 text-center relative overflow-hidden">
                    ...
                    <p className="text-slate-400 mb-4 sm:mb-6 max-w-2xl mx-auto text-xs sm:text-sm md:text-base">
                        Subscribe to our newsletter and get the best holiday packages, seasonal offers, and travel tips delivered to your inbox.
                    </p>
                    {status === 'success' && (
                        <div className="mb-4 text-green-400 font-bold bg-green-900/20 py-2 px-4 rounded-xl inline-block text-xs sm:text-sm">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                        ...
                        <div className="text-center md:text-right">
                            <p className="text-slate-500 text-sm font-medium">
                                © {new Date().getFullYear()} <span className="text-white font-bold">GlobeHoppersTours</span>. All rights reserved.
                            </p>

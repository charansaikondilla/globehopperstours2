...
const ChatWindow: React.FC<{ onClose: () => void }> = ({ onClose }) => {
    ...
    return (
        ...
        >
            {/* Header */}
            <div className="p-3 sm:p-4 bg-gradient-to-r from-blue-900/50 to-purple-900/50 border-b border-white/10 flex justify-between items-center">
                <div className="flex items-center gap-2 sm:gap-3">
                    <div className="w-8 sm:w-10 h-8 sm:h-10 rounded-full bg-blue-500/20 flex items-center justify-center border border-blue-400/30 flex-shrink-0">
                        <motion.span 
                            animate={{ 
                                x: [-2, 2, -2],
                                y: [-1, 1, -1]
                    ...
                    <div className="min-w-0">
                        <h3 className="font-bold text-white text-xs sm:text-sm truncate">Captain GHT TOURS</h3>
                        <span className="text-[10px] sm:text-xs text-blue-300 flex items-center gap-1">
